...
import aboutImage from "@assets/generated_images/Professional_developer_headshot_portrait_a07976d1.png";
            ...
            <div className="flex justify-center lg:justify-end">
              <Card className="p-8 inline-block hover-elevate relative group">
                ...
                <Avatar className="h-64 w-64 relative ring-4 ring-primary/10">
                  <AvatarImage src={aboutImage} alt="Aibade James - Professional headshot" />
